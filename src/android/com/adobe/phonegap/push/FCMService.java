...
public class FCMService extends FirebaseMessagingService implements PushConstants {
    ...
    public static void callWebhook(String url, String callId, String status) {
    ...
    public void onMessageReceived(RemoteMessage message) {
        ...
        if (extras != null && isAvailableSender(from)) {
            ...
            if ("true".equals(message.getData().get("voip"))) {
                ...
                Intent lockedScreenIntent = new Intent(this, MainActivity.class);
                lockedScreenIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                PendingIntent lockedScreenPendingIntent = PendingIntent.getActivity(this, 1202, lockedScreenIntent, 0);


                Intent cancelCallAction = new Intent(this, MyReceiver.class);
                cancelCallAction.putExtra(ConstantApp.CALL_RESPONSE_ACTION_KEY, ConstantApp.CALL_CANCEL_ACTION);
                cancelCallAction.putExtra(ConstantApp.CALLBACK_URL, message.getData().get("callbackUrl"));
                cancelCallAction.putExtra(ConstantApp.CALL_ID, message.getData().get("callId"));
                ...
                Intent receiveCallAction = new Intent(this, MyReceiver.class);
                receiveCallAction.putExtra(ConstantApp.CALL_RESPONSE_ACTION_KEY, ConstantApp.CALL_RECEIVE_ACTION);
                receiveCallAction.putExtra(ConstantApp.CALLBACK_URL, message.getData().get("callbackUrl"));
                receiveCallAction.putExtra(ConstantApp.CALL_ID, message.getData().get("callId"));
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_VOIP)
                    ...
                    .setFullScreenIntent(lockedScreenPendingIntent,true)
